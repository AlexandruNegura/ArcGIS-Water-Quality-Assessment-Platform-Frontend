$(window).on("load", function () {
	...
	require([
		...
		"esri/dijit/Legend",
		"esri/dijit/Scalebar",
		"dojo/domReady!js/prj/content/pag_4"
	], function (
		parser,
		ready,
		BorderContainer,
		...
		ready(function () {
			...
			arcgisUtils.createMap("903ca98573374d419b4defafaf6342e6", "map").then(function (response) {
				...
				let visibleLayerName = ["PH", "MuresApe2"];
				let visibleLayerID = {};
                ...
                map.on("click", function(evt) {
                    selectGraphicsNearSelectedOne(evt, "Time", "PH", map.getLayer(visibleLayerID[visibleLayerName[0]]));
                });
			});
		});
	});
